                        ...
                        <div className="right-content">
                            <div className="right-content-body">
                                <div className="section">
                                    ...
                                    <InputField type="password" name="createpassword" labelFor="createpassword" label="Password" />
                                    <InputField type="password" name="createpassword" labelFor="createpassword" label="Confirm Password" />
                                </div>
                                <div className="section">
